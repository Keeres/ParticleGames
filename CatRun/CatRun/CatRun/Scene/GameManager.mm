...
-(void)runSceneWithID:(SceneTypes)sceneID {
    ...
    switch (sceneID) {
        case kMainMenuScene: 
            ...
            break;
        case kMiniGameScene: {
            [GameState sharedInstance].currentMiniGameSelected = @"Flying_Normal_01";
            [GameState sharedInstance].currentActivePerk = kFlying;
            sceneToRun = [MiniGameScene scene];
            break;
        }
        case kOptionsScene:
            break;
