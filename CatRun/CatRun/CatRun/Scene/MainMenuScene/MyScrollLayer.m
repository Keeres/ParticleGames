    ...
    if ((self = [super init])) {
     ...
     //   CCLayerColor *layerColor = [CCLayerColor layerWithColor:ccc4(150, 0, 255, 255)];
      //  [self addChild:layerColor];
        ...
        maxScrollingVelocity = 50.0;          
        
        Area = CGRectMake(240.0, yStartPostion, 240.0, 300.0);
...
- (void) visit {
    ...
    CGRect scissorRect = CGRectMake(480.0, 0.0, 480.0, 640.0);
...
-(BOOL)ccTouchBegan:(UITouch *)touch withEvent:(UIEvent *)event{
    ...
    if (CGRectContainsPoint(Area, currentTouch)) {
