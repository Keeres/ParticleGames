...
-(void) directorDidReshapeProjection:(CCDirector*)director
{
	if(director.runningScene == nil) {
        ...
        // Setup Parse
        [Parse setApplicationId:@"cYqI9VE2yVvtk3rtBJaSBgd2wd22fB026ztq5FIC" clientKey:@"uidXZnD7fz1oEsiyAfmKHLZZZt5PnlwkkBk4j0X1"];
        [ChallengesInProgress registerSubclass];
